...
sentiment = pd.read_csv('data\\sentiment.csv', index_col='Date', date_format='%YY-%mm-%dd', parse_dates=True)
...
class cot_data:
    ...
    def __init__(self):
        self.aggregated_reports = pd.read_csv('data\\agg_legacy_reports', index_col='As of Date in Form YYYY-MM-DD')
